package com.mars.base.framework.archetype.test;
...
/**
 * 启动 jetty ,启动完成后通过 http://localhost:8080/base-framework-archetype 访问项目
 *
 * @author maurice
 */
public class LaunchJetty {
     ...
     * 启动jetty时，默认方法的项目名称
     */
    public static final String DEFAULT_CONTEXT_PATH = "/base-framework-archetype";
    /**
     * spring 环境属性
     */
