package com.mars.base.framework.archetype.commons.valid;

import com.mars.base.framework.archetype.commons.valid.annotation.MapValid;
import com.mars.map.validation.MapValidation;
import com.mars.map.validation.ValidError;
...
public class MapValidManager {
    ...
    @Before("execution(* com.mars.base.framework.archetype.service.*..*(..))")
